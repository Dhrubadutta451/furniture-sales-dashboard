...
## Dataset used
- <a href="https://github.com/Dhrubadutta451/furniture-sales-dashboard/blob/main/Furniture-Sales-Dashbaord.xlsx">Dataset<a/>
...
## Key Findings
For example it's selected in Consumer segment in South region
